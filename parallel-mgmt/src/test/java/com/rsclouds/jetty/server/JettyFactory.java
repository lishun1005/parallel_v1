...
/**
 * 
 * Description:创建Jetty Server的工厂类
 *
...
public class JettyFactory {
	...
	//* idea配置*//
	private static final String DEFAULT_WEBAPP_PATH = "parallel-mgmt/src/main/webapp";
	private static final String WINDOWS_WEBDEFAULT_PATH = "parallel-mgmt/src/test/resources/webdefault.xml";
