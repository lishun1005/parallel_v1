...
public class ImageMutilLayersSplit extends FileSplit{
	...
	public ImageMutilLayersSplit(String hdfspath, String fileName, String outputPath, long xOrigin, long yOrigin, long xLength, long yLength, double resolution, int currentLayers) {
		super(new Path(hdfspath), xLength, yLength, null);
	...
	public ImageMutilLayersSplit(String hdfspath, String fileName, String outputPath, long xOrigin, long yOrigin, long xLength, long yLength, double[] max, double[] min, double resolution, int[] bands, int currentLayers) {
		super(new Path(hdfspath), xLength, yLength, null);
		this.gtdataOutputPath.set(outputPath);
		this.xOrigin = xOrigin;
		this.yOrigin = yOrigin;
	...
	public void setFileName(Text fileName) {
		this.fileName.set(fileName.toString());
	}
