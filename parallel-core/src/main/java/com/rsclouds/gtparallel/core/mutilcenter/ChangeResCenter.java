...
public class ChangeResCenter extends Configured implements Tool {
	public static Logger LOG = LoggerFactory.getLogger(ChangeResCenter.class);
	public static final String KEY_OLD_CENTER = "old_center";
	public static final String KEY_NEW_CENTER = "new_center";
	public static final byte[] RES_FAMILY_BYTES = "img".getBytes();
	public static final byte[] RES_QUALIFIER_DFS_BYTES = "dfs".getBytes();
	public static final byte[] RES_QUALIFIER_SIZE_BYTES = "size".getBytes();
	public static final byte[] RES_QUALIFIER_LINKS_BYTES = "links".getBytes();
	public static final byte[] RES_QUALIFIER_DATA_BYTES = "data".getBytes();
	...
	public static class MapperRead extends TableMapper<ImmutableBytesWritable, Text> {
		...
		public void map(ImmutableBytesWritable key, Result value, Context context)
			...
			byte[] dfsBytes = value.getValue(RES_FAMILY_BYTES, RES_QUALIFIER_DFS_BYTES);
	...
	public static class ReducerWrite extends TableReducer<ImmutableBytesWritable, Text, NullWritable> {
		...
		public void reduce(ImmutableBytesWritable key, Iterable<Text> values, Context context)
			...
			put.add(RES_FAMILY_BYTES, RES_QUALIFIER_DFS_BYTES, valueText.toString().getBytes());
	...
	public int run(String[] args)throws Exception {
		...
		job.setJarByClass(ChangeResCenter.class);
	...
	public static void main(String[] args) throws Exception {
		int status = ToolRunner.run(new ChangeResCenter(), args);
		System.exit(status);
	}
}
